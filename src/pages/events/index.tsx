...
export function EventListPage(props: EventListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEvents({
        relations: [
          'user',
          'booking_event_participation_rewardsTobooking',
          'booking_booking_event_idToevent.count',
          'team.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'booking_event_participation_rewardsTobooking',
          header: 'Booking Event Participation Rewards Tobooking',
          accessorKey: 'booking_event_participation_rewardsTobooking',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/bookings/view/${record.booking_event_participation_rewardsTobooking?.id}`}
            >
              {record.booking_event_participation_rewardsTobooking?.booking_time}
            </Link>
          ),
        }
      : null,
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'booking_booking_event_idToevent',
          header: 'Booking Booking Event Id Toevent',
          accessorKey: 'booking_booking_event_idToevent',
          cell: ({ row: { original: record } }: any) => record?._count?.booking_booking_event_idToevent,
        }
      : null,
