...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBookings({
        relations: ['user', 'event_booking_event_idToevent', 'event_event_participation_rewardsTobooking.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('event', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'event_booking_event_idToevent',
          header: 'Event Booking Event Id Toevent',
          accessorKey: 'event_booking_event_idToevent',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/events/view/${record.event_booking_event_idToevent?.id}`}
            >
              {record.event_booking_event_idToevent?.name}
            </Link>
          ),
        }
      : null,
    hasAccess('event', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'event_event_participation_rewardsTobooking',
          header: 'Event Event Participation Rewards Tobooking',
          accessorKey: 'event_event_participation_rewardsTobooking',
          cell: ({ row: { original: record } }: any) => record?._count?.event_event_participation_rewardsTobooking,
        }
      : null,
