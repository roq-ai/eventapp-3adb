...
import { getEventLocationById } from 'apiSdk/event-locations';
...
function EventLocationViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<EventLocationInterface>(
    () => (id ? `/event-locations/${id}` : null),
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('event_location', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/event-locations/edit/${id}`} passHref legacyBehavior>
                    <Button
