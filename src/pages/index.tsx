  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="EventApp - Discover, Book, and Participate in Local Events. A Central Dashboard for Operations Staff. Your Social Companion for Event Participation with Virtual Buddies."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1549451371-64aa98a6f660?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxldmVudHN8ZW58MHx8fHwxNjk1NTA1MjM0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`EventApp - Discover, Book, and Participate in Local Events. A Central Dashboard for Operations Staff. Your Social Companion for Event Participation with Virtual Buddies.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Event Organizer" type="event-organizer" abilities={appConfig.ownerAbilities} />
