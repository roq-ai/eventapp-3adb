...
import { getTrainerSpecializationById, updateTrainerSpecializationById } from 'apiSdk/trainer-specializations';
...
function TrainerSpecializationEditPage() {
  ...
  const handleSubmit = async (values: TrainerSpecializationInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateTrainerSpecializationById(id, values);
      mutate(updated);
      resetForm();
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Update Trainer Specialization',
              isCurrent: true,
            },
          ]}
        />
